...
const useCases: UseCase[] = [
  {
    ...
    solutionPoints: [
      "One live board for every job, candidate, and stage.",
      "AI-generated summaries of who’s stuck and why.",
      "Instant clarity on offers, drop-offs, and delays.",
    ],
    visual: "hr-control",
  },
  {
    ...
    solutionPoints: [
      ...
      "Side-by-side comparisons for final shortlist decisions.",
    ],
    visual: "tech-skills",
  },
  {
    ...
    solutionPoints: [
      "AI reads responsibilities, domain, and role nature.",
      "Shows experience patterns that match each JD.",
      "Gives a clear narrative you can share with hiring managers.",
    ],
  ...
  },
  {
    ...
    solutionPoints: [
      "Org-level view of all jobs, stages, and bottlenecks.",
      "Role-wise and recruiter-wise throughput metrics.",
      "AI-generated weekly hiring digest you can forward as-is.",
    ],
    visual: "ta-dashboard",
  },
  {
    ...
    solutionPoints: [
      "Central candidate graph across all client accounts.",
      "Tagging by client, role, seniority, and outcome.",
      "Quickly resurface ‘almost selected’ candidates for new roles.",
    ],
    visual: "agency-graph",
  },
];
